...
echo_and_run cd "/home/robot/workspaces/ur5_controllers/src/universal_robot/ur_kinematics"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/robot/workspaces/ur5_controllers/src/universal_robot/ur_kinematics/setup.py" \
     \
    build --build-base "/home/robot/workspaces/ur5_controllers/build/universal_robot/ur_kinematics" \
    install \
    --root="${DESTDIR-/}" \
